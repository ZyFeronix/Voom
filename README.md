...
**VSOCIAL** nace semanas después del retiro de WoWonder de CodeCanyon, no es un clon.
...
**Estado:** Alpha v0.5 — Funcional completo, 16 módulos, 35 tablas, 24 API endpoints. En desarrollo activo.
