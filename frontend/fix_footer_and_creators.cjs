...
newHtml = newHtml.replace(/<div class="creator-card glass-panel hover-lift"/g, '<div class="creator-card"');
newHtml = newHtml.replace(/<div class="btn-liquidglass-wrap primary-wrap w-full mt-4" style="flex: 0 0 44px; min-height: 44px;">/g, '<div class="btn-liquidglass-wrap primary-wrap" style="width: 100%; margin-top: 1.25rem; flex: 0 0 44px; min-height: 44px;">');
newHtml = newHtml.replace(/<button class="btn-liquidglass-primary w-full h-full">/g, '<button class="btn-liquidglass-primary" style="width: 100%; height: 100%;">');
