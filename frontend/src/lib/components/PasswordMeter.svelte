<script>
	...
	const strength = $derived(
		score >= 85
			? { label: 'Excelente', color: '#00E676', glow: 'rgba(0,230,118,0.4)' }
			: score >= 65
				? { label: 'Fuerte', color: '#69F0AE', glow: 'rgba(105,240,174,0.3)' }
				: score >= 45
					? { label: 'Media', color: '#FFD740', glow: 'rgba(255,215,64,0.3)' }
					: score >= 25
						? { label: 'Débil', color: '#FF9100', glow: 'rgba(255,145,0,0.3)' }
