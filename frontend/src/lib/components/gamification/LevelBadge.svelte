...
>
	...
	{#if tier === 6}
		<div
			class="absolute inset-0 bg-gradient-to-tr from-transparent via-white/30 to-transparent mix-blend-overlay pointer-events-none liquid-shine"
		></div>
	{/if}

	<span
		class="relative z-10 drop-shadow-md flex items-center gap-[2px] whitespace-nowrap leading-none"
	>
