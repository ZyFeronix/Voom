...
export const APP_PRESETS = [
	{
		...
		name: 'Aqua Gel 2004',
		icon: 'water',
		desc: 'Botones gel translúcidos, era Tiger',
		accentColor: '#0099ff',
		borderRadius: 'sharp',
		cardOpacity: 85,
		aeroGloss: true,
	...
	},
	{
		...
		name: 'Eco Solarpunk',
		icon: 'eco',
		desc: 'Verde vital y burbujas orgánicas',
		accentColor: '#10b981',
		borderRadius: 'bubble',
		cardOpacity: 90,
		aeroGloss: true,
	...
	},
	{
		...
		icon: 'filter_drama',
		desc: 'Frosted glass estilo Aero 7',
		accentColor: '#0ea5e9',
	...
	},
	{
		...
		name: 'Orbe Neo-Aero',
		icon: 'blur_circular',
		desc: 'Revival gloss Y2K vibrante',
		accentColor: '#06b6d4',
		borderRadius: 'modern',
		cardOpacity: 75,
		aeroGloss: true,
	...
	},
	{
		...
		name: 'Abismo Bio',
		icon: 'dark_mode',
		desc: 'Aqua nocturno bioluminiscente',
		accentColor: '#2dd4bf',
		borderRadius: 'rounded',
		cardOpacity: 70,
		aeroGloss: false,
