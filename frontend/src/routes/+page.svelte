				...
				<div class="aero-window glass-panel">
					...
					<div class="window-container">
						<div class="window-sidebar">
							<button
								class="sidebar-item"
								class:active={activeMockupTab === 'feed'}
								onclick={() => (activeMockupTab = 'feed')}
							>
							...
							<button
								class="sidebar-item"
								class:active={activeMockupTab === 'analytics'}
								onclick={() => (activeMockupTab = 'analytics')}
							>
							...
							<button
								class="sidebar-item"
								class:active={activeMockupTab === 'gamification'}
							...
							<button
								class="sidebar-item"
								class:active={activeMockupTab === 'engine'}
								onclick={() => (activeMockupTab = 'engine')}
							>
								...
								<div class="mock-feed">
									...
									>
										<div class="post-user">
											<div
												class="post-avatar"
												style="flex: 0 0 40px; min-width: 40px; min-height: 40px; background: radial-gradient(circle, var(--accent-light), var(--accent-primary))"
											>
												AP
											</div>
										...
										<div class="post-visual-chart glass-card">
											...
											<div class="chart-row">
												...
												<div class="bar-container">
													<div class="bar bar-slow" style="width: 80%"></div>
												</div>
							...
							{:else if activeMockupTab === 'analytics'}
								<div class="mock-analytics">
									...
									<div class="analytics-grid">
										<div
											class="analytic-card glass-card"
											role="presentation"
											onmousemove={handleCardMouseMove}
										>
									...
									<div
										class="analytics-chart-container glass-card"
										role="presentation"
										onmousemove={handleCardMouseMove}
									>
										...
										<svg class="analytics-svg" viewBox="0 0 300 80" aria-hidden="true">
											...
											/>
											<path
												d="M 0 80 Q 25 35 50 45 T 100 20 T 150 50 T 200 15 T 250 35 T 300 10 L 300 80 Z"
												fill="url(#chart-grad)"
											/>
											<path
												d="M 0 80 Q 25 35 50 45 T 100 20 T 150 50 T 200 15 T 250 35 T 300 10"
												fill="none"
												stroke="var(--accent-primary)"
												stroke-width="2"
												class="chart-line-pulse"
											/>
								...
								<div class="mock-gamification">
									...
									<div class="gami-leaderboard">
										<div class="lb-row lb-gold glass-card">
											...
											<div
												class="lb-avatar"
												style="flex:0 0 30px;min-width:30px;min-height:30px;background:radial-gradient(circle,#fbbf24,#f59e0b)"
											>
												L3
											</div>
											<div class="lb-info">
												...
												<div class="lb-xp-bar">
													<div class="lb-xp-fill" style="width:92%"></div>
												</div>
											</div>
										...
										<div class="lb-row glass-card">
											...
											<div
												class="lb-avatar"
												style="flex:0 0 30px;min-width:30px;min-height:30px;background:radial-gradient(circle,#ec4899,#bf5af2)"
											>
												AH
											</div>
											<div class="lb-info">
												...
												<div class="lb-xp-bar">
													<div class="lb-xp-fill" style="width:74%"></div>
												</div>
											</div>
										...
										<div class="lb-row glass-card">
											...
											<div
												class="lb-avatar"
												style="flex:0 0 30px;min-width:30px;min-height:30px;background:radial-gradient(circle,#34d399,#00d4aa)"
											>
												NB
											</div>
											<div class="lb-info">
												...
												<div class="lb-xp-bar">
													<div class="lb-xp-fill" style="width:58%"></div>
												</div>
											</div>
...
export const getFeed = (limit=20, offset=0) =>
  stmt.all(limit, offset);`}</code
			...
			<div class="marquee-inner">
				{#each Array(2) as _}
					<span class="marquee-item"
						><span class="material-icons-round">bolt</span> SvelteKit 5 Runes</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">storage</span> SQLite WAL Mode</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">gavel</span> Licencia AGPLv3</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
					...
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">emoji_events</span> Gamification Engine</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
					...
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">play_circle</span> Reels 60FPS</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
					...
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">auto_awesome</span> LiquidglassUI 2.0</span
					>
					<span class="marquee-sep">·</span>
					<span class="marquee-item"
						><span class="material-icons-round">dns</span> Self-Hosted · $4/mes</span
					>
					<span class="marquee-sep">·</span>
				{/each}
			</div>
	...
	<section id="features" class="features-section" data-section="features">
		...
		<div
			class="features-scroll-wrapper hide-scrollbar"
		...
		>
			<div class="features-grid" role="presentation">
				<div
					class="features-card glass-card hover-lift"
					role="presentation"
					onmousemove={handleCardMouseMove}
				>
					<div class="card-refraction"></div>
	...
	<section id="gamification" class="gami-section" data-section="gami">
		...
		<div class="gami-layout">
			<div class="gami-cards">
				<div
					class="gami-feature-card glass-panel"
					role="presentation"
					onmousemove={handleCardMouseMove}
				>
					<div class="card-refraction"></div>
	...
	<section id="sandbox" class="sandbox-section" data-section="sandbox">
		<div class="sandbox-layout">
			<!-- Theme Switcher -->
			<div
				class="theme-customizer glass-panel"
				role="presentation"
				onmousemove={handleCardMouseMove}
			>
				<div class="card-refraction"></div>
			...
			<div class="live-sandbox glass-panel" role="presentation" onmousemove={handleCardMouseMove}>
				...
				<div class="sandbox-feed-display">
					{#each sandboxPosts as post}
						<div
							class="sandbox-post-item glass-card"
							role="presentation"
							onmousemove={handleCardMouseMove}
						>
							<div class="item-header">
								<div
									class="item-avatar"
									style="flex: 0 0 34px; min-width: 34px; min-height: 34px; background: radial-gradient(circle, var(--accent-light), var(--accent-primary))"
								>
		...
		<div class="creators-grid">
			<div class="creator-card glass-panel" role="presentation" onmousemove={handleCardMouseMove}>
				...
				<div class="creator-header">
					<div
						...
						style="flex: 0 0 52px; min-width: 52px; min-height: 52px; background: radial-gradient(circle, #5ac8fa, #1b85f3)"
					>
						L3
					</div>
			...
			<div class="creator-card glass-panel" role="presentation" onmousemove={handleCardMouseMove}>
				...
				<div class="creator-header">
					<div
						class="creator-avatar"
						style="flex: 0 0 52px; min-width: 52px; min-height: 52px; background: radial-gradient(circle, #ff2d55, #ec4899)"
					>
						AH
					</div>
					<div class="creator-meta">
			...
			<div class="creator-card glass-panel" role="presentation" onmousemove={handleCardMouseMove}>
				...
				<div class="creator-header">
					<div
						class="creator-avatar"
						style="flex: 0 0 52px; min-width: 52px; min-height: 52px; background: radial-gradient(circle, #34d399, #00d4aa)"
					>
						NB
					</div>
					<div class="creator-meta">
...
<style>
	...
	.aero-wrapper {
		...
		--glass-card-gradient: linear-gradient(
			145deg,
	...
	.glass-card:hover .card-refraction {
		opacity: 1;
	}
	...
	.mock-like-btn .material-icons-round {
		font-size: 14px;
	}
	.mock-like-btn.liked {
		color: var(--status-red);
	...
	.mock-comment-stat .material-icons-round {
		font-size: 14px;
	}
	...
	.features-scroll-wrapper.dragging .features-card {
		pointer-events: none;
	}
	...
	.drag-hint .material-icons-round {
		font-size: 16px;
	}
	...
	.gami-icon-wrap .material-icons-round {
		font-size: 24px;
	}
	...
	.gbp-badge .material-icons-round {
		font-size: 1.3rem;
	}
	.gbp-badge:hover {
	...
	.glb-rank.bronze {
		background: rgba(180, 120, 68, 0.2);
		color: #b47844;
	}
	.glb-name {
		flex: 1;
	...
	.gami-cta-icon .material-icons-round {
		font-size: 32px;
	}
	.gami-cta-content {
		flex: 1;
	...
	.liquid-sphere {
		...
		box-shadow:
			...
			inset 3px 3px 6px var(--glass-panel-bg);
	}
	.picker-info strong {
		display: block;
		font-size: 0.82rem;
	...
	.item-avatar {
		...
		box-shadow:
			...
			inset 0 0 0 1px var(--glass-panel-border);
	}
	.item-meta {
		display: flex;
		flex-direction: column;
	...
	.status-badge.live {
		background: rgba(0, 228, 100, 0.1);
		border: 1px solid rgba(0, 228, 100, 0.25);
		color: #00e464;
	}
