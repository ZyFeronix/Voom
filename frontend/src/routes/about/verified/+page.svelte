	...
	const roles = [
		{
			...
			perks: [
				'Acceso a Panel de Control Global',
				'Moderación Absoluta',
		...
		},
		{
			...
			perks: [
				'Insignia Aero Blue',
				'Garantía de Identidad en Búsquedas',
...
<div class="verified-container" in:fade={{ duration: 600 }}>
	<div class="page-header">
		...
		<p class="header-subtitle">
			En V-SOCIAL, la autoridad se gana y se distingue con claridad. Conoce nuestras insignias.
		</p>
	</div>
	...
	<div class="apply-section">
		<div class="apply-content">
			<span class="material-icons-round text-6xl mb-4" style="color: var(--aero-blue);"
				>gpp_good</span
			>
			...
			<button
				class="btn-aero-primary mt-6 text-lg px-8 py-3 rounded-xl font-bold flex items-center justify-center gap-2 mx-auto"
	...
	>
		...
		>
			...
			<div class="modal-header">
				<span class="material-icons-round text-5xl mb-2" style="color: var(--aero-blue);"
					>verified</span
				>
				<h2
			...
			<div class="modal-body text-center mt-4">
				...
				<div
					class="glass-panel mt-6 p-4 rounded-xl text-left"
					style="border: 1px solid var(--border-glass);"
				>
					<h3 class="font-bold text-sm mb-2" style="color: var(--text-primary);">
						Requisitos Mínimos:
					</h3>
			...
			<div class="modal-footer mt-6 flex justify-end">
				<button
					class="btn-aero-primary w-full text-lg py-3 rounded-xl font-bold"
					style="box-shadow: var(--neon-primary); border-radius: 14px;"
					onclick={() => (showModal = false)}>Entendido</button
				>
			</div>
		</div>
	</div>
...
<style>
	...
	.role-card:hover {
		...
		box-shadow:
			...
			0 0 25px var(--role-color, transparent);
