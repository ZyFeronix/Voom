...
{:else}
  ...
  <div class="metrics-grid">
    ...
    <div class="metric-card glass-card">
      <div class="metric-icon" style="background: var(--grad-primary); color: #fff; box-shadow: 0 4px 15px rgba(46,134,232,0.4), inset 0 2px 4px rgba(255,255,255,0.4);">
          ...
          {#each activity as act}
            <div class="activity-item">
              ...
              <div class="act-content">
                <p class="act-text">
                  <span class="act-user">@{act.actor_username || 'Sistema'}</span> {act.body || act.message}
                </p>
...
<style>
  ...
  .act-avatar .material-icons-round { font-size: 18px; color: var(--text-muted); }
  ...
  .act-user { font-weight: 700; color: var(--text-primary); }
