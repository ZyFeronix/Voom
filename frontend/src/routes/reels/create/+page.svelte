		...
		<div class="phase-2-editor" in:fade={{ duration: 400, delay: 200 }}>
			...
			<div class="video-preview-column">
				...
				<div class="main-video-container">
					<MediaPlayer src={preview} type="video" class="main-video" autoplay={true} />
				</div>
			</div>

			<!-- Columna Derecha: Consola Neo-Aero (Sidebar) -->
			<div
				class="creator-side-console"
				in:fly={{ x: 200, duration: 600, easing: cubicOut, delay: 300 }}
			>
				...
				<div class="console-body">
					...
					<div class="info-block">
						...
						<p>
							Los videos públicos pueden ser vistos y compartidos por cualquier usuario en V-SOCIAL.
						</p>
					</div>
				</div>
...
<style>
	...
	.error-toast {
		...
		z-index: 110;
		background: rgba(232, 74, 114, 0.2);
	...
	.massive-dropzone:hover,
	.massive-dropzone.dragging {
		border-color: var(--aero-sky);
		background: rgba(255, 255, 255, 0.05);
		box-shadow:
			0 0 50px rgba(46, 134, 232, 0.15),
			inset 0 0 30px rgba(46, 134, 232, 0.1);
		transform: scale(1.02);
	}
	.massive-dropzone:hover::before,
	.massive-dropzone.dragging::before {
		opacity: 1;
	}
	...
	.glow-ring {
		...
		color: var(--aero-sky);
		margin-bottom: 32px;
		box-shadow: 0 0 30px rgba(46, 134, 232, 0.3);
		transition: transform 0.4s;
	}
	.glow-ring .material-icons-round {
		font-size: 48px;
	}
	.massive-dropzone:hover .glow-ring {
		transform: scale(1.1);
	...
	} /* En tablet/movil ocupa más espacio */
	...
	.discard-btn {
		background: rgba(232, 74, 114, 0.05);
		color: var(--aero-rose);
	...
	.discard-btn:hover:not(:disabled) {
		...
		box-shadow: 0 4px 12px rgba(232, 74, 114, 0.2);
	}
	...
	.cinematic-textarea:focus {
		border-color: var(--aero-sky);
		outline: none;
		background: rgba(0, 0, 0, 0.5);
		box-shadow:
			inset 0 2px 10px rgba(0, 0, 0, 0.6),
			0 0 15px rgba(46, 134, 232, 0.15);
	}
	.cinematic-textarea:disabled {
		opacity: 0.6;
	}
	...
	.publish-hero-btn:hover:not(:disabled) {
		...
		box-shadow: 0 15px 40px rgba(46, 134, 232, 0.5);
	}
