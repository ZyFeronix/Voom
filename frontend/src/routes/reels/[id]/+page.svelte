...
<div class="fixed inset-0 bg-black z-50 flex items-center justify-center">
	...
	<!-- Contenedor del Reel -->
	<div
		class="relative w-full max-w-[450px] h-[100dvh] bg-zinc-900 overflow-hidden flex flex-col justify-center shadow-2xl"
		in:fade
	>
		<video
		...
		<!-- Overlay info -->
		<div
			class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/40 to-transparent pointer-events-none flex flex-col gap-3"
		>
